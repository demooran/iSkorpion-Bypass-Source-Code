...
namespace iSkorpionA12
{
    public partial class CustomMessageBox : Form
    {
        ...
        // Properties for custom button text
        public string CustomOKText { get; set; } = "OK";
        public string CustomCancelText { get; set; } = "Cancel";
        public string CustomYesText { get; set; } = "Yes";
        public string CustomNoText { get; set; } = "No";
        public string CustomRetryText { get; set; } = "Retry";
        public string CustomAbortText { get; set; } = "Abort";
        public string CustomIgnoreText { get; set; } = "Ignore";
        ...
        // Static properties for default button text (global settings)
        public static string DefaultOKText { get; set; } = "OK";
        public static string DefaultCancelText { get; set; } = "Cancel";
        public static string DefaultYesText { get; set; } = "Yes";
        public static string DefaultNoText { get; set; } = "No";
        public static string DefaultRetryText { get; set; } = "Retry";
        public static string DefaultAbortText { get; set; } = "Abort";
        public static string DefaultIgnoreText { get; set; } = "Ignore";
        ...
        {
            return Show(message, title, buttons, icon, null, null, null, null, null, null, null);
        }

        // Main Show method with custom button text support
        public static DialogResult Show(string message, string title, MessageBoxButtons buttons,
                                        MessageBoxIcon icon, string okText = null, string cancelText = null,
                                        string yesText = null, string noText = null, string retryText = null,
                                        string abortText = null, string ignoreText = null)
        {
            using (var form = new CustomMessageBox())
            {
                // Set custom button texts if provided, otherwise use defaults
                form.CustomOKText = !string.IsNullOrEmpty(okText) ? okText : DefaultOKText;
                form.CustomCancelText = !string.IsNullOrEmpty(cancelText) ? cancelText : DefaultCancelText;
                form.CustomYesText = !string.IsNullOrEmpty(yesText) ? yesText : DefaultYesText;
                form.CustomNoText = !string.IsNullOrEmpty(noText) ? noText : DefaultNoText;
                form.CustomRetryText = !string.IsNullOrEmpty(retryText) ? retryText : DefaultRetryText;
                form.CustomAbortText = !string.IsNullOrEmpty(abortText) ? abortText : DefaultAbortText;
                form.CustomIgnoreText = !string.IsNullOrEmpty(ignoreText) ? ignoreText : DefaultIgnoreText;
        ...
        // Overloaded Show methods for convenience
        public static DialogResult Show(string message, string title, MessageBoxButtons buttons,
                                        string okText = null, string cancelText = null,
                                        string yesText = null, string noText = null)
        {
            return Show(message, title, buttons, MessageBoxIcon.None, okText, cancelText, yesText, noText);
        }

        public static DialogResult Show(string message, string title, MessageBoxButtons buttons,
                                        string okText, string cancelText)
        {
            return Show(message, title, buttons, MessageBoxIcon.None, okText, cancelText);
        }

        public static DialogResult Show(string message, string title, MessageBoxButtons buttons,
                                        string yesText, string noText, string cancelText = null)
        {
            return Show(message, title, buttons, MessageBoxIcon.None, null, cancelText, yesText, noText);
        }
        ...
        private void CreateButtons(MessageBoxButtons buttons)
        {
            ...
            // Apply custom text to buttons
            btnOK.Text = CustomOKText;
            btnCancel.Text = CustomCancelText;
            btnYes.Text = CustomYesText;
            btnNo.Text = CustomNoText;
            btnRetry.Text = CustomRetryText;
            btnAbort.Text = CustomAbortText;
            btnIgnore.Text = CustomIgnoreText;
        ...
        private void PositionButtons(Button[] buttons)
        {
            ...
            // Recalculate button widths based on text
            foreach (Button btn in buttons)
            {
                Size textSize = TextRenderer.MeasureText(btn.Text, btn.Font);
                btn.Width = Math.Max(btn.Width, textSize.Width + 20); // Add padding
        ...
        private void SizeFormToContent()
        {
            ...
            // Recalculate button positions after form resize
            ...
            {
                PositionButtons(visibleButtons.ToArray());
            }
